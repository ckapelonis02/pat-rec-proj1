...
def main():
    ...
    df_train = df_train[df_train['label'].isin([1, 2, 3])]  # Get samples from the selected digits only
    ...
    df_test = df_test[df_test['label'].isin([1, 2, 3])]  # Get samples from the selected digits only
